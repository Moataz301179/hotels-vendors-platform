...
import { EmptyState, PageHead, Pager, T, Td, TextInput, Th } from "@/lib/stubs-export";
import { IcHistory, IcSearch } from "@/lib/stubs-export";
...
export default function AuditPage() {
  ...
  const list = useMemo(() => {
    ...
    return data.audit.filter(
      (a: { actor: string; entity: string; action: string; detail: string; detailAr: string }) =>
