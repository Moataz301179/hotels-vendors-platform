...
import { Btn, Card, Field, PageHead, TextInput } from "@/lib/stubs-export";
import { IcScale } from "@/lib/stubs-export";
...
export default function RulesPage() {
  ...
  const matched = data.rules.find((r: any) => evAmount >= r.min && (r.max === null || evAmount <= r.max));
                  ...
                  matched.approvers.length === 0 ? (
                    ...
                    <span>
                      {t("admin.rules.evalResult", {
                        ...
                        r: matched.approvers.map((a: any) => t(`role.${a}`)).join(" + "),
                        s: matched.slaHours,
                      })}
                    </span>
                  )
